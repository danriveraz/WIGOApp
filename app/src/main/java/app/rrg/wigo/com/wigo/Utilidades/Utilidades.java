...
public class Utilidades {
    ...
    public static final String CREAR_EVENTO = "CREATE TABLE "+TABLA_EVENTO+"("+ID_EVENTO+" INTEGER PRIMARY KEY AUTOINCREMENT, "+NOMBRE_EVENTO+" TEXT, "+DESCRIPCION_EVENTO+" TEXT,"+HORA_EVENTO+" TEXT,"+FECHA_EVENTO+" TEXT,"+PRECIO_EVENTO+" REAL,"+DIRECCION_EVENTO+" TEXT,"+CREADOR_EVENTO+" INTEGER,FOREIGN KEY("+CREADOR_EVENTO+") REFERENCES usuarios("+ID_USUARIO+"));";
}
